...
import { ClipboardCheck, ArrowLeft, ArrowRight, ShieldCheck, Trophy, PlayCircle, BookOpen } from "lucide-react";
...
const CATEGORY_KEYWORDS: Record<string, string[]> = {
  "Phishing": ["phishing", "فيشينج", "احتيال", "تصيد", "phish", "تحقق", "رابط مشبوه"],
  "Password Security": ["password", "كلمة مرور", "كلمات مرور", "passwords", "مرور", "كلمة السر"],
  "2FA": ["2fa", "مصادقة", "two-factor", "verification", "تحقق", "otp", "ثنائي"],
  "Public Wi-Fi": ["wifi", "wi-fi", "واي فاي", "شبكة", "network", "vpn", "عامة"],
  "Social Engineering": ["social engineering", "هندسة اجتماعية", "social", "هندسة", "خداع", "تلاعب"],
  "Privacy": ["privacy", "خصوصية", "تواصل اجتماعي", "social media", "وسائل التواصل"],
      ...
      {step === "result" && (() => {
        ...
        return (
          ...
          >
            ...
            {/* Smart Recommendations — Video section */}
                ...
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-muted-foreground">
                      {isRTL
                        ? "فيديوهات مختارة بناءً على نقاط ضعفك في الاختبار"
                        : "Videos selected based on your quiz weak points"}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-3 overflow-x-auto pb-1 snap-x snap-mandatory scrollbar-hide">
                  {recommendedVideos.map((video) => (
                    ...
                    >
                      ...
                      <div className="p-3">
                        <p className="text-xs font-semibold leading-snug line-clamp-2 text-white/90 group-hover:text-primary transition-colors">
                          {video.title}
                        </p>
